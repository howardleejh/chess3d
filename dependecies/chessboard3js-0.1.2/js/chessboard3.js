        ...
        */
        ...
        function animateSquareToSquare(src, dest, completeFn) {
            ...
            if (destSquareMesh && pieceMesh) {
                var tx_src = pieceMesh.position.x,
                    tz_src = pieceMesh.position.z;
                var tx_dest = destSquareMesh.position.x,
                    tz_dest = destSquareMesh.position.z;
                startTween(function (t) {
        ...
        function dropDraggedPieceOnSquare() {
            ...
            var src = DRAG_INFO.source,
                tgt = DRAG_INFO.location,
        ...
        function addSquareHighlight(sq, color) {
            ...
            if (squareMesh) {
                ...
                highlightMesh = new THREE.Mesh(highlight_geometry, new THREE.MeshBasicMaterial({
